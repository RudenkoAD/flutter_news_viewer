...
class ArticleTileState extends State<ArticleTile> with SingleTickerProviderStateMixin{
                  ...
                  trailing: AnimatedBuilder(
                    ...
                    builder: (context, _) {
                      return IconButton(
                        ...
                        onPressed: () {
                          ref.read(favouriteProvider).isFavourite(article) ? _controller.reverse() : _controller.forward();
